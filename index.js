...
bot.on('message', function (message) {
  if (message.content === '!promo') {
    message.reply("Tiens, 10% de réduction sur le site Formicants.com avec le code : 1stOrder")
  }
})
...
bot.on('message', function (message) {
  if (message.content === '!crematogaster') {
    message.reply('https://grainesdegaia.fr/categorie-produit/fourmis/fondation-et-colonies/')
  }
})
